...
describe("App component", () => {
    ...
    it("routes check", async () => {
        expext(global.fetch).toHaveBeenCalledTimes(1);
    ...
    it("data map check", () => {
        const data = [
            {
                ...
                courseName: "Node.js",
                courseDept: "WD",
                description: "NOde.js is used to create back-end service",
                duration: 10,
                isRated: false,
                isApplied: true,
                noOfRating: 15,
            ...
            },
            {
                ...
                courseName: "React.js",
                courseDept: "WD",
                description: "React.js is used to create front-end service",
                duration: 14,
                isRated: true,
                isApplied: true,
                noOfRating: 145,
            ...
            },
            {
                ...
                courseName: "Angular",
                courseDept: "WD",
                description: "Angular is used to create back-end service",
                duration: 18,
                isRated: true,
                isApplied: false,
                noOfRating: 10,
        ...
        expect(component.find("ul").at(0).find("li").at(5).text()).toBe("10 hrs . 15 rating . 4.5/5")
        ...
        expect(component.find("ul").at(1).find("li").at(4).text()).toBe("14 hrs . 145 rating . 4.3/5")
        ...
        expect(component.find("ul").at(2).find("li").at(4).text()).toBe("18 hrs . 10 rating . 4.5/5")
    ...
    it("Add rating Check", () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(
            "http://localhost:8001/course/rating/5ff5706baf74d71378df935f", {
            "method": "PATCH",
    ...
    it("Apply check", async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(
            "http://localhost:8001/course/enroll/5ff5706baf74d71378df935f", {
            "method": "post",
            "headers": { "Content- Type ": "application/json" },
        }
        );
